...
| INT8 trilogy | `prep_method`, `test_taker`, `target_score`, `test_history` | `recent_score`, `wrong_reasons` |
...
**After:** "Based on what you shared — group class and a goal of 1300–1400 — the pattern we usually see is the same few skill gaps costing points, not weakness in every topic."
